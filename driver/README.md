...
**Status:** Driver-cell prototype verified end-to-end (Phase 4); first real driver loads and performs I/O inside real ReactOS (Phase 5)
...
`iommu/`, `net/`, `storage/`, `usb/` are still untouched — later-phase
territory once a real Windows driver needs one of them.
